***Data Preperation Repeated PD*************************************************
********************************************************************************

clear
set scheme s2color
graph set window fontface "Arial"
global MY_PATH_IN   "C:\Users\Admin\Desktop\paper\02_experiment_repeated_prisoners\data/"
global MY_PATH_OUT  "C:\Users\Admin\Desktop\paper\02_experiment_repeated_prisoners\data/"
global OUT_TABLES  "C:\Users\Admin\Desktop\paper\02_experiment_repeated_prisoners\data/"
...
********************************************************************************
*Figure A2 - Cheating among Defections******************************************
********************************************************************************
*Scatter Payoff Cheat D among D*************************************************

gen def_count = cooperation if cooperation == 0

egen N_def = count(def_count), by (id)

gen cheat_def_def_count = cheat_d if cheat_d == 1

egen N_cheat_def_def = count(cheat_def_def_count), by (id)

gen n_cheat_def_def_b = N_cheat_def_def/N_def
lab var n_cheat_def_def_b "Share Cheat D choices among all defections"
...
grstyle set size 8pt: key_label
grstyle set size 8pt: legend
graph twoway (lfit ave_payoff n_cheat_def_def_b) (scatter ave_payoff n_cheat_def_def_b) if treatment == 2 & match == 1 & period == 1, title("Hidden 25 (p = 0.367)") ytitle("Payoff per round") yscale(range(12 20)) ylabel(12(2)20)
graph save "${MY_PATH_OUT}Scatter_Cheat_D_D_T2", replace

reg ave_payoff n_cheat_def_def_b if treatment == 2 & match == 1 & period == 1
...
grstyle set size 8pt: key_label
grstyle set size 8pt: legend
graph twoway (lfit ave_payoff n_cheat_def_def_b) (scatter ave_payoff n_cheat_def_def_b) if treatment == 3 & match == 1 & period == 1, title("Revealed 25 (p = 0.412)") ytitle("Payoff per round") yscale(range(12 20)) ylabel(12(2)20)
graph save "${MY_PATH_OUT}Scatter_Cheat_D_D_T3", replace

reg ave_payoff n_cheat_def_def_b if treatment == 3 & match == 1 & period == 1
...
grstyle set size 8pt: key_label
grstyle set size 8pt: legend
graph twoway (lfit ave_payoff n_cheat_def_def_b) (scatter ave_payoff n_cheat_def_def_b) if treatment == 4 & match == 1 & period == 1, title("Hidden 12.5 (p = 0.195)") ytitle("Payoff per round") yscale(range(12 20)) ylabel(12(2)20)
graph save "${MY_PATH_OUT}Scatter_Cheat_D_D_T4", replace

reg ave_payoff n_cheat_def_def_b if treatment == 4 & match == 1 & period == 1
...
grstyle set size 8pt: key_label
grstyle set size 8pt: legend
graph twoway (lfit ave_payoff n_cheat_def_def_b) (scatter ave_payoff n_cheat_def_def_b) if treatment == 5 & match == 1 & period == 1, title("Revealed 12.5 (p=0.031)") ytitle("Payoff per round") yscale(range(12 20)) ylabel(12(2)20)
graph save "${MY_PATH_OUT}Scatter_Cheat_D_D_T5", replace

reg ave_payoff n_cheat_def_def_b if treatment == 5 & match == 1 & period == 1

********************************************************************************
*Combine for Figure A2**********************************************************

gr combine "${MY_PATH_OUT}Scatter_Cheat_D_D_T5" "${MY_PATH_OUT}Scatter_Cheat_D_D_T3" "${MY_PATH_OUT}Scatter_Cheat_D_D_T4" "${MY_PATH_OUT}Scatter_Cheat_D_D_T2", title("Cheat D among defections")
graph save "${MY_PATH_OUT}Scatter_Cheat_D_D_ALL", replace
